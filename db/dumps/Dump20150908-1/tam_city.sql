...
CREATE TABLE `city` (
  ...
  KEY `INX_CITY_COUNTRY_REGION_CODE` (`region_code`),
  ...
  CONSTRAINT `FK_CITY_COUNTRY_REGION_CODE` FOREIGN KEY (`region_code`) REFERENCES `region` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION
