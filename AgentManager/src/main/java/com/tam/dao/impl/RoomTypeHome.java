...
/**
 * Home object for domain model class RoomType.
 * @see .RoomType
 * @author Hibernate Tools
 */
public class RoomTypeHome {

	private static final Log log = LogFactory.getLog(RoomTypeHome.class);
	...
	public void persist(RoomType transientInstance) {
		log.debug("persisting RoomType instance");
		try {
	...
	public RoomType merge(RoomType detachedInstance) {
		...
		try {
			RoomType result = (RoomType) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public RoomType findById(java.lang.String id) {
		log.debug("getting RoomType instance with id: " + id);
		try {
			RoomType instance = (RoomType) sessionFactory.getCurrentSession().get("RoomType", id);
			if (instance == null) {
	...
	public List findByExample(RoomType instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("RoomType").add(Example.create(instance))
					.list();
