...
public class SegmentHome {
	...
	public Segment merge(Segment detachedInstance) {
		...
		try {
			Segment result = (Segment) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Segment findById(java.lang.Integer id) {
		...
		try {
			Segment instance = (Segment) sessionFactory.getCurrentSession().get("Segment", id);
			if (instance == null) {
	...
	public List findByExample(Segment instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Segment").add(Example.create(instance))
					.list();
