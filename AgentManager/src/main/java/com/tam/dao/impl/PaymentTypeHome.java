...
public class PaymentTypeHome {
	...
	public PaymentType findById(java.lang.String id) {
		log.debug("getting PaymentType instance with id: " + id);
		try {
			PaymentType instance = (PaymentType) sessionFactory.getCurrentSession().get("PaymentType", id);
			if (instance == null) {
	...
	public List findByExample(PaymentType instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("PaymentType")
